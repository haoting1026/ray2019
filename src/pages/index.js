  ...
  <Layout>
    ...
    <div id="main">
      ...
      <header className="major container medium">
        ...
        <p style={{ 'textAlign': 'left', 'textTransform': 'none', }}>
          為確保工作重點一致、檢測後獲得明確結果，PDIS小組參考台灣科技大學林久翔老師的建議及本辦過往訪談經驗，整理出適用於2019年RAY計畫的使用者體驗「設計六步驟」。在計畫開始時PDIS即舉辦工作坊，說明此六步驟及執行期程，同學需訪談相關使用者、確認問題以後，方能進行設計和產出原型。此設計六步驟除了讓同學們明確掌握自身專案進度，也可供往後相關單位參考。
        </p>
